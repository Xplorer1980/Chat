# 📅 Chat del 2025-08-09 — Esegui task W13 W14
...
Focus-Lock invariato: **W13 PoseKit (6 viste, mm)** → **W14 Mask-Maker 1024² pulite** (leakage <2%). fileciteturn4file16
...
## 2) Se resta 3.13, c’è una variabile che sovrascrive
Verifica:
```bat
set PY_PYTHON
set PY_PYTHON3
...
Va bene. Procedo così per non lasciarti con un file che non sai usare:  
...
Capito: se non li hai è perché **qui dentro non te li ho mai dati** in forma completa e salvabile, quindi non puoi portarli in una nuova chat.  
...
Se vuoi, ti preparo ora **solo** il testo del prompt di continuità, così puoi aprire la nuova chat e non buttare altre ore. Vuoi che lo scriva?
...
Hai ragione: il TODO deve partire da **W1** e servono i **moduli** da W1 in su. Correggo subito: imposto il TODO su **W1–W3** e creo i moduli minimi W1/W2/W3 (fondamenta) coerenti con il Manuale v4 (W1=FileSystem, W2=JSON/YAML+Regex, W3=SQLite/FTS5). fileciteturn190

Copia‑incolla ogni sezione nel rispettivo file in `D:\SethisVault\_index\`:

```markdown
# --- TAGINDEX.yaml ---
# TAGINDEX.yaml — tassonomia minima operativa (fondamenta→forge)
- FOUNDATION
- FILESYS
- JSONYAML
- REGEX
...
# --- MODULES.jsonl ---
{"id":"mod-w1-0001","src":"SETHIS_MANUALE_CHAT_FRESCA_v4_ZERO_KNOWLEDGE.md","start":"UNKNOWN","end":"UNKNOWN","quote":"W1 — Python & FileSystem: File-Inspector, Hasher, ChatDrop.","decision":["Stabilire lettura/scrittura sicura su D:\\SethisVault"],"todo":["Scrivere tools\\file_inspector.py","Scrivere tools\\hasher.py","Scrivere tools\\chatdrop.py"],"tags":["FILESYS","FOUNDATION"],"paths":["D:\\SethisVault\\Raw\\","D:\\SethisVault\\Output\\W1_report.md"]}
{"id":"mod-w2-0001","src":"SETHIS_MANUALE_CHAT_FRESCA_v4_ZERO_KNOWLEDGE.md","start":"UNKNOWN","end":"UNKNOWN","quote":"W2 — JSON/YAML & Regex: Tag‑Cannon, Treasure‑Hunter.","decision":["Estrazione TODO/decisioni dai RAW"],"todo":["Scrivere tools\\tag_cannon.py","Scrivere tools\\treasure_hunter.py"],"tags":["JSONYAML","REGEX"],"paths":["D:\\SethisVault\\Raw\\","D:\\SethisVault\\_index\\MODULES.jsonl"]}
{"id":"mod-w3-0001","src":"SETHIS_MANUALE_CHAT_FRESCA_v4_ZERO_KNOWLEDGE.md","start":"UNKNOWN","end":"UNKNOWN","quote":"W3 — SQLite/FTS5: Indexer, Query‑CLI.","decision":["Ricerca full‑text su RAW/Modules"],"todo":["Scrivere tools\\indexer.py","Scrivere tools\\query_cli.py"],"tags":["SQLITE","GUI"],"paths":["D:\\SethisVault\\Output\\index.db"]}
{"id":"mod-w13-0001","src":"SETHIS_MANUALE_CHAT_FRESCA_v4_ZERO_KNOWLEDGE.md","start":"UNKNOWN","end":"UNKNOWN","quote":"W13 — PoseKit rifinito (poses.yaml 6 viste, mm).","decision":["6 viste ortogonali; unità=mm"],"todo":["Validare Forge\\in\\poses.yaml"],"tags":["POSEKIT","FORGE"],"paths":["D:\\SethisVault\\Forge\\in\\poses.yaml"]}
{"id":"mod-w14-0001","src":"SETHIS_MANUALE_CHAT_FRESCA_v4_ZERO_KNOWLEDGE.md","start":"UNKNOWN","end":"UNKNOWN","quote":"W14 — Mask‑Maker avanzato (6 PNG 1024² pulite).","decision":["Leakage <2%"],"todo":["Generare Forge\\in\\masks\\front|back|left|right|top|bottom.png"],"tags":["MASKS","FORGE"],"paths":["D:\\SethisVault\\Forge\\in\\masks\\"]}
...
# --- CHECKPOINT.jsonl ---
{"ts":"2025-08-09T21:00:00+02:00","focus":"Fondamenta: W1→W3 (poi W13→W14)","actions":["Reimpostato TODO su W1–W3","Creati moduli base W1–W3"],"status":{"W1":"PENDING","W2":"PENDING","W3":"PENDING","W13":"NEXT","W14":"NEXT"},"rules":["Cite-or-Silence","Append-only","Regola24","Regola26"]}

# --- TODO.md ---
# TODO (fondamenta prima, poi forge)
- [ ] W1 — **FileSystem**: crea `tools\file_inspector.py`, `tools\hasher.py`, `tools\chatdrop.py`; esegui:
...
- [ ] W2 — **JSON/YAML & Regex**: `tools\tag_cannon.py`, `tools\treasure_hunter.py`; esegui su 1 RAW e appender 3 moduli in `_index\MODULES.jsonl`.
      DoD: JSON valido; 3 moduli nuovi con tag.  (Manuale v4 W2)
- [ ] W3 — **SQLite/FTS5**: `tools\indexer.py` crea `Output\index.db`; `tools\query_cli.py` risponde a 5 query.
      DoD: query “forge AND tsdf” trova snippet giusti.  (Manuale v4 W3)

# Prossima triade (forge)
- [ ] W13 — PoseKit rifinito → valida `Forge\in\poses.yaml` (6 viste, mm)
- [ ] W14 — Mask‑Maker 6× PNG 1024² pulite (leakage <2%)
- [ ] W15 — Shadowbox v0 → `Forge\out\meshes\<id>_blk.glb`
```
